...
It produces the `quarkus-serverless-1.0-SNAPSHOT-runner.jar` file in the `/build` directory. Be aware that it’s not an _
...
The application is now runnable using `java -jar build/quarkus-serverless-1.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./build/quarkus-serverless-1.0-SNAPSHOT-runner`
